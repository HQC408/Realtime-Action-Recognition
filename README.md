...
```
python src\s5_test.py --model_path model\trained_classifier.pickle --data_type folder --data_path data_test/exercise.avi --output_folder output 
python src/s5_test.py --model_path model/trained_classifier.pickle --data_type video --data_path data_test/video/punch_video.mp4 --output_folder output/
...
python src/s5_test.py \
    ...
    --output_folder output
```
python src\s5_test.py --model_path model\trained_classifier.pickle --data_type folder --data_path data_test/apple/ --output_folder output
python src\s5_test.py --model_path model\trained_classifier.pickle --data_type folder --data_path data_test/images/ --output_folder output
...
python src/s5_test.py \
    ...
    --output_folder output
```
python src\s5_test.py --model_path model\trained_classifier.pickle --data_type webcam --data_path 0 --output_folder output
